...
$(document).ready(function() {
    ...
    document.title = gameName + " - Setup Wizard";
    ...
    function install() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Installing.. <strong>[' + y + '%]</strong>');
    ...
    function callback() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Configuring the download and installation process...<strong>[' + i + '%]</strong>');
