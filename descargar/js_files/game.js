...
$(document).ready(function() {
    ...
    document.title = gameName + " - Asistente De Configuración";
    ...
    function install() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Instalación.. <strong>[' + y + '%]</strong>');
    ...
    function callback() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Configurar el proceso de descarga e instalación...<strong>[' + i + '%]</strong>');
