...
$(document).ready(function() {
    ...
    document.title = gameName + " - Einrichtungsassistent";
    ...
    function install() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Installieren.. <strong>[' + y + '%]</strong>');
    ...
    function callback() {
        ...
        var progressBar = setInterval(function() {
            $('.loading-text').html('Konfigurieren Sie den Herunterladen und den Installationsprozess...<strong>[' + i + '%]</strong>');
